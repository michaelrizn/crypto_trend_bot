...
output_path = ('/Users/mikhailryazanov/PycharmProjects/crypto_trend_bot/logs/project_tree_output'
               '.txt')
...
os.makedirs('/Users/mikhailryazanov/PycharmProjects/crypto_trend_bot/logs', exist_ok=True)
